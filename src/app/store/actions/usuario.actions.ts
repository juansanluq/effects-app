...
export const CARGAR_USUARIO_SUCCESS = '[Usuario] Cargar usuario SUCCES';
...
export type usuarioAcciones = CargarUsuarioAction | CargarUsuarioFail | CargarUsuarioSuccess;
